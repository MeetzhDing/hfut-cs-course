...
def main():
    ...
    parser.add_argument('--image_path', type=str, default=
                        join(config['data_dir'], 'val2014/COCO_val2014_000000561100.jpg'),
                        help='Image Path')
    parser.add_argument('--model_path', type=str, default='Data/Models/model1.ckpt',
                        help='Model Path')
    ...
    parser.add_argument('--question', type=str, default='这是飞机吗',
                        help='Question')
    ...
    vocab_data = data_loader.get_question_answer_vocab(data_dir=args.qa_dir)
    qvocab = vocab_data['question_vocab']
    q_map = {vocab_data['question_vocab'][qw]: qw for qw in vocab_data['question_vocab']}

    fc7_features = utils.extract_fc7_features(args.image_path, config['model_path'])
